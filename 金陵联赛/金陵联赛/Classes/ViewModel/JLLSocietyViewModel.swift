...
class JLLSocietyViewModel{
    ...
    func society_init(){
        ...
        society.append(JLLSociety(composeImage: "WechatIMG275", userImage: "Messi", nameLabel: "axiba", timeLabel: "00:00", titleLabel: "今天分享的是朱教练的跑位训练方法", statusLabel: "球员们都平行站位，防守球员最后一名中后卫拖后，而进攻的球员距离防线3米左右，在看到长传球后加速冲刺，穿过整条防线"))
        society.append(JLLSociety(composeImage: "WechatIMG276", userImage: "Cristiano Ronaldo", nameLabel: "西罗", timeLabel: "00:00", titleLabel: "【赛事预告】商南大金陵校队将于3月17日下午三点30分对抗南信工", statusLabel: "解释各个院队的精英们将在球场上奋力拼搏，此次热身赛也是为了将要到来的省运会预选赛做准备，希望大家届时为我校队加油！"))
        society.append(JLLSociety(composeImage: "WechatIMG277", userImage: "Cristiano Ronaldo", nameLabel: "西罗", timeLabel: "00:00", titleLabel: "【赛事预告】商南大金陵校队将于3月17日下午三点30分对抗南信工", statusLabel: "解释各个院队的精英们将在球场上奋力拼搏，此次热身赛也是为了将要到来的省运会预选赛做准备，希望大家届时为我校队加油！"))
    }
}
